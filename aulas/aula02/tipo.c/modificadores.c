...
int main() {
  ...
  signed int inteiro_com_sinal; // -2bi a 2bi 4bytes
  ...
  long int inteiro_long_com_sinal; // -9hexa a 9hexa 8 bytes
  unsigned long int inteiro_longo_sem_sinal; // 0 a 18 hexa
